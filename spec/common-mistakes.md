...
See [Strings](strings.md) for the full explanation. Short version: backticks only, always.
...
See [Collections](collections.md) for details. `array`, `fixed`, `map` are all lowercase.
