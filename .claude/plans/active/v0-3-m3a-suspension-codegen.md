...
- [x] Iterations are sequential — per-iteration side effects are strictly ordered (fixture (e); locks `design/concurrency.md` "loop iterations sequential")
