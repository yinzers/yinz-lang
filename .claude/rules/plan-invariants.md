...
- New executable feature → add to `examples/basics/entrypoint.ynz` showing the feature in a small but realistic context (not just `print(featureName())` — show it doing real work)
