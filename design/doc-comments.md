...
**Inline vs leading**: Both forms work. `ynz fmt` normalizes trailing-comment alignment (see `design/open-questions.md` formatter section). The `ynz doc` generator accepts both.
...
2. **`ynz doc` generated output**: see `design/future/doc-generator.md`
...
- `spec/doc-comments.md` — user-facing spec (the "how to write them")
- `design/future/doc-generator.md` — `ynz doc` command design
- `design/ide-hints.md` — LSP hover format spec
- `design/lsp.md` — doc-comment attachment in the parser (Phase 10 of v0.2-M5)
- `design/open-questions.md` — trailing-comment alignment in `ynz fmt`
