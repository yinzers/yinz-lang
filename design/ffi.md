...
- **C type mapping**: How do C types like `void*`, `char*`, `struct*`, and function pointers map to Yinz types? Is there a raw `pointer` type? See `design/open-questions.md`.
