...
The capability API must follow `.claude/rules/stdlib-design.md`:
...
- [`architecture.md`](architecture.md) — the bridge these capabilities ride on
- [`build-targets.md`](build-targets.md) — where per-platform permission metadata is emitted during packaging
- `.claude/rules/stdlib-design.md` — the contract this API obeys
- `.claude/rules/inference.md` / `design/golden-rules.md` Rule 11 — teaching diagnostics for undeclared-capability errors
