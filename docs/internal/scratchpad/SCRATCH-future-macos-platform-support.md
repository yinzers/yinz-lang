---
name: "SCRATCH-future-macos-platform-support"
description: "Tracks why macOS was dropped from CI on 2026-06-01 (failing codegen golden tests), what's missing, and what re-adding verified macOS support would require."
tags:
  - "yinz-compiler"
...
- [`.claude/todos.md`](../../../.claude/todos.md) — "macos-ci-codegen-support" tracked item
- [`docs/internal/scratchpad/SCRATCH-future-designs-index.md`](SCRATCH-future-designs-index.md) — future-locked design index
