---
name: "SCRATCH-stdlib-strings"
description: "Per-method documentation for the M7 string API. All methods are on the built-in string type — no import needed."
tags:
  - "yinz-compiler"
...
User spec: [`docs/reference/REF-strings.md`](../../reference/REF-strings.md)
...
- [`docs/reference/REF-strings.md`](../../reference/REF-strings.md) — user-facing surface (audience: HS-grad JS developer)
- [`docs/internal/implementation/IMP-strings.md`](../implementation/IMP-strings.md) — SSO layout, NFC propagation table, SIMD crate selection
- [`docs/internal/implementation/IMP-collections.md`](../implementation/IMP-collections.md) — bracket sugar (`s[n]` → `.get(n)`), shared indexing API design
