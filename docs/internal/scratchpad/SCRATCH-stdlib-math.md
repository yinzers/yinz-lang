---
name: "SCRATCH-stdlib-math"
description: "Comprehensive math module. Scientist-grade coverage. Tree shaking means unused functions cost nothing — add everything."
tags:
  - "yinz-compiler"
