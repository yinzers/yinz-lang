---
name: "SCRATCH-future-cross-module-frame-serialization"
description: "Design notes (shipped in v0.3-M3e) for the codegen-side cross-module frame_layouts_query that computes LLVM-accurate suspending-function frame layouts across separately-compiled source files."
tags:
  - "yinz-compiler"
...
**Status**: Shipped in v0.3-M3e. See [`.claude/planning/done/2026-06-05-v0-3-m3e-cross-module-frame-serialization/plan.md`](../../../.claude/planning/done/2026-06-05-v0-3-m3e-cross-module-frame-serialization/plan.md)
...
The `.ynzlib` binary-package format ([`docs/internal/scratchpad/SCRATCH-future-packages.md`](SCRATCH-future-packages.md)), when it ships, will need
