---
name: "IMP-scope"
description: "Design decisions for Yinz's block-scoping rules, the ban on mutable file-level variables, and compile-time evaluation of file-level const expressions."
tags:
  - "yinz-compiler"
...
User spec: [`docs/reference/REF-scope.md`](../../reference/REF-scope.md)
