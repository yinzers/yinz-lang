---
name: "IMP-lsp"
description: "This doc is for compiler contributors and milestone implementers, not Yinz language users. It covers how ynz-lsp is structured, why it works the way it does, and what is deferred to v0.2-M5."
tags:
  - "yinz-compiler"
...
Plan reference: [`.claude/planning/done/2026-05-20-v0-2-m2-lsp-thin-slice/plan.md`](../../../.claude/planning/done/2026-05-20-v0-2-m2-lsp-thin-slice/plan.md) (M2); [`.claude/planning/done/2026-05-20-v0-2-m5-lsp-full-and-release/plan.md`](../../../.claude/planning/done/2026-05-20-v0-2-m5-lsp-full-and-release/plan.md) (M5)

Cross-references: [`docs/internal/decisions/ADR-compiler-language.md`](../decisions/ADR-compiler-language.md), [`docs/internal/implementation/IMP-feature-registry.md`](IMP-feature-registry.md), [`docs/reference/REF-teaching-mission.md`](../../reference/REF-teaching-mission.md), [`.claude/rules/inference.md`](../../../.claude/rules/inference.md), [`.claude/planning/done/2026-05-18-v0-2-dev-loop-tooling/roadmap.md`](../../../.claude/planning/done/2026-05-18-v0-2-dev-loop-tooling/roadmap.md)
...
**v0.2-M5 note:** When go-to-def / rename / find-refs scale horizontally (multi-window, background analysis), this model is revisited with salsa snapshots. See [`.claude/planning/done/2026-05-18-v0-2-dev-loop-tooling/roadmap.md`](../../../.claude/planning/done/2026-05-18-v0-2-dev-loop-tooling/roadmap.md) M5 entry.
...
- `inlayHintProvider` — muted-hint surfaces per [`.claude/rules/inference.md`](../../../.claude/rules/inference.md)
...
- Adding a new keyword to [`registry/features.toml`](../../../registry/features.toml) makes it appear in autocomplete AND in hover AND as a syntax-highlighted token (via the TextMate grammar generator) — no `ynz-lsp` code changes needed.
...
Rationale (from [`crates/ynz-lsp/_spike/MEASUREMENTS.md`](../../../crates/ynz-lsp/_spike/MEASUREMENTS.md)):
...
The Yinz compiler enforces WHAT/WHAT-INSTEAD/WHY structure in every diagnostic (see [`docs/reference/REF-teaching-mission.md`](../../reference/REF-teaching-mission.md) and [`docs/reference/REF-compiler-errors.md`](../../reference/REF-compiler-errors.md)). The LSP must NOT lose this structure when transforming `ynz_diagnostics::Diagnostic` to `lsp_types::Diagnostic`.
...
This mirrors the self-hosting plan in [`docs/internal/implementation/IMP-feature-registry.md`](IMP-feature-registry.md). The Rust `ynz-lsp` runs as the production implementation until the Yinz-hosted version reaches feature parity. At that point, `crates/ynz-lsp/` is deprecated and eventually deleted.
...
The following LSP capabilities were out of scope for v0.2-M2 and shipped in v0.2-M5 ([`.claude/planning/done/2026-05-20-v0-2-m5-lsp-full-and-release/plan.md`](../../../.claude/planning/done/2026-05-20-v0-2-m5-lsp-full-and-release/plan.md)):

- `textDocument/definition` — go-to-def (cross-file span lookup via `symbol_lookup.rs`)
...
**What is NOT in M5**: renaming a field inside a shape declaration; renaming an aliased re-export (`export { Crew as Captain }` — see [`registry/features.toml`](../../../registry/features.toml) `lsp-rename-aliased-re-export` deferred entry).
...
See [`.claude/rules/inference.md`](../../../.claude/rules/inference.md) for the three placement categories (Addition / Replacement / Informational) and the full protocol spec.
...
| `allocators` | Protocol-only | Addition | (empty — awaiting arena keyword) | N/A until `arena scratch { }` ships | v0.3 (per [`docs/internal/scratchpad/SCRATCH-future-arena.md`](../scratchpad/SCRATCH-future-arena.md)) |

Cross-reference: [`docs/reference/REF-ide-hints.md`](../../reference/REF-ide-hints.md) for the protocol spec; [`registry/features.toml`](../../../registry/features.toml) `[[muted_hint_domain]]` entries for the canonical domain definitions.
