---
name: "IMP-sensitive"
description: "Design decisions for the sensitive type modifier used to mark secret values (e.g. sensitive string), env.get() defaulting to sensitive, and automatic redaction across all output paths."
tags:
  - "yinz-compiler"
...
User spec: [`docs/reference/REF-sensitive.md`](../../reference/REF-sensitive.md)
