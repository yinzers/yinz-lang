---
name: "IMP-gpu"
description: "Vision document for Yinz GPU dispatch (deferred to MVP2+): letting the compiler transparently manage CPU/GPU data placement and execution under the same syntax."
tags:
  - "yinz-compiler"
