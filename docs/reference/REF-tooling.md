---
name: "REF-tooling"
description: "The ynz CLI builds, runs, and watches your code."
tags:
  - "yinz-compiler"
...
See [Testing](REF-testing.md) for the full test spec.
...
See [Packages](REF-packages.md) for the full package spec.
